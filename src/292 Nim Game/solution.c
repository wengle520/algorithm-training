 ...
 */
/**
 * you must think of a way to win!!!
 ...
 * which will leave the death number 4 to the second player. i.e.
 * The numbers 5, 6, 7 are winning numbers for any player who got it first.
